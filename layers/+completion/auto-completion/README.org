...
** TabNine
[[https://tabnine.com/][TabNine]] is the all-language autocompleter. It uses machine learning to provide
responsive, reliable, and relevant suggestions.
To enable TabNine backend, set the variable
=auto-completion-enable-sort-by-usage= to =t=.
This feature is provided by the [[https://github.com/TommyX12/company-tabnine][company-tabnine]] package when =company= is used.
